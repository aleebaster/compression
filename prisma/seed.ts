...
async function main() {
  ...
  await prisma.banner.upsert({
    ...
    create: {
      ...
      height: JSON.stringify({ desktop: 750, tablet: 600, mobile: 700 }),
      maxWidth: JSON.stringify({ desktop: 1920, tablet: 1024, mobile: 375 }),
      maxHeight: JSON.stringify({ desktop: 750, tablet: 600, mobile: 700 }),
