  ...
  try {
    ...
    const banner = await prisma.banner.create({
      data: {
        ...
        objectFit: body.objectFit ?? "contain",
        positionX: body.positionX ?? 0,
        positionY: body.positionY ?? 0,
        objectPosition: body.objectPosition ?? "center",
        scale: body.scale ?? 1,
        width: body.width ?? { desktop: "100%", tablet: "100%", mobile: "100%" },
        height: body.height ?? { desktop: 750, tablet: 600, mobile: 700 },
        maxWidth: body.maxWidth ?? { desktop: 1920, tablet: 1024, mobile: 375 },
        maxHeight: body.maxHeight ?? { desktop: 750, tablet: 600, mobile: 700 },
